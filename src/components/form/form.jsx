  ...
  return (
    <>
      <section className="h-screen flex flex-col justify-center items-center px-4">
        <h2 className="text-3xl sm:text-4xl mt-20 md:text-5xl lg:text-6xl font-bold text-center mb-15"> ¡Dale forma a tu inspiración! </h2>
        ...
        >
          ...
          />
          <button type="submit" className="w-auto self-center rounded bg-white font-bold cursor-pointer hover:bg-gray-200 px-3 py-2 mb-14 sm:px-4 sm:py-5">
            Guardar </button>
        </form>
      </section>
    </>
